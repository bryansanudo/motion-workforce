...
const IResources = ({ language }) => {
  const faq = {
    en: {
      ...
      a14: "The process of obtaining a Green Card through the EB-3 program generally consists of several steps, including obtaining a labor certification, filing a foreign worker petition, and finally, the issuance of the Green Card. The typical timeframe for this process can vary depending on the applicant's location, application status, and industry type. Tipically, it can take between 12 and 18 months, but this time can vary. It's important to consult with EB-3 Workforce Solutions for a more precise estimate based on your situation.",
    },
    es: {
