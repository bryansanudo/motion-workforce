...
const IResources = ({ language }) => {
  const faq = {
    ...
    es: {
      ...
      a7: "as distintas entidades gubernamentales que intervienen en el proceso de aprobación de la tarjeta de residencia para el proceso EB3 exigen que los solicitantes no tengan antecedentes penales en ningún país en el que hayan vivido, además, el Departamento de Aduanas y Servicios de Inmigración de los Estados Unidos también realiza una exhaustiva comprobación de antecedentes, incluidas las estancias anteriores en los EE.UU.",
      ...
      a13: "El programa de visados EB-3 es una iniciativa de inmigración basada en el empleo que permite a las empresas estadounidenses patrocinar a trabajadores extranjeros para obtener una Tarjeta Verde (residencia permanente). Esto ayuda a su empresa a cubrir puestos que se enfrentan a una escasez crónica de trabajadores no cualificados, poniendo en contacto a empresarios con empleados inmigrantes dispuestos a solicitar una Tarjeta Verde a través del programa EB-3. Esto proporciona una solución a largo plazo a sus necesidades de mano de obra cualificada",
      q14: "¿Cuál es el proceso y el plazo típicos para obtener una Tarjeta Verde a través del programa EB-3?",
      a14: "El proceso de obtención de una Tarjeta Verde a través del programa EB-3 generalmente consta de varios pasos, incluyendo la obtención de una certificación laboral, la presentación de una petición de trabajador extranjero y, finalmente, la emisión de la Tarjeta Verde. El plazo típico de este proceso puede variar en función de la ubicación del solicitante, el estado de la solicitud y el tipo de industria. Por lo general, tarda unos 18 meses, pero este plazo puede variar. Es importante consultar con EB-3 Workforce Solutions para obtener una estimación más precisa basada en su situación",
    },
    por: {
